...
export const BIBLE_BOOKS: BibleBook[] = [
  ...
  { name: '1 Samuel', abbreviation: '1 Sam', chapters: 31, testament: 'OT' },
  { name: '2 Samuel', abbreviation: '2 Sam', chapters: 24, testament: 'OT' },
  { name: '1 Kings', abbreviation: '1 Kgs', chapters: 22, testament: 'OT' },
  { name: '2 Kings', abbreviation: '2 Kgs', chapters: 25, testament: 'OT' },
  { name: '1 Chronicles', abbreviation: '1 Chr', chapters: 29, testament: 'OT' },
  { name: '2 Chronicles', abbreviation: '2 Chr', chapters: 36, testament: 'OT' },
  ...
  { name: '1 Corinthians', abbreviation: '1 Cor', chapters: 16, testament: 'NT' },
  { name: '2 Corinthians', abbreviation: '2 Cor', chapters: 13, testament: 'NT' },
  ...
  { name: '1 Thessalonians', abbreviation: '1 Thess', chapters: 5, testament: 'NT' },
  { name: '2 Thessalonians', abbreviation: '2 Thess', chapters: 3, testament: 'NT' },
  { name: '1 Timothy', abbreviation: '1 Tim', chapters: 6, testament: 'NT' },
  { name: '2 Timothy', abbreviation: '2 Tim', chapters: 4, testament: 'NT' },
  ...
  { name: '1 Peter', abbreviation: '1 Pet', chapters: 5, testament: 'NT' },
  { name: '2 Peter', abbreviation: '2 Pet', chapters: 3, testament: 'NT' },
  { name: '1 John', abbreviation: '1 John', chapters: 5, testament: 'NT' },
  { name: '2 John', abbreviation: '2 John', chapters: 1, testament: 'NT' },
  { name: '3 John', abbreviation: '3 John', chapters: 1, testament: 'NT' },
...
/** Resolve a book name from various formats (e.g. "1 Sam", "Psalm", "Psalms", "Gen") */
export function resolveBookName(input: string): string | null {
  ...
  // Partial match
  const partial = BIBLE_BOOKS.find(
    b => b.name.toLowerCase().startsWith(normalized.toLowerCase())
  );
